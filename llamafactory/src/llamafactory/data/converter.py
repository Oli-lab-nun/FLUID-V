...
class SharegptDatasetConverter(DatasetConverter):
    def __call__(self, example: dict[str, Any]) -> dict[str, Any]:
        ...
        if self.dataset_attr.images and self.dataset_attr.images not in example:
            if self.dataset_attr.images == "images" and "image" in example:
                example["images"] = example["image"]
            elif self.dataset_attr.images == "image" and "images" in example:
