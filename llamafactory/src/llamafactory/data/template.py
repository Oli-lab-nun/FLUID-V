...
class Template:
    ...
    def fix_special_tokens(self, tokenizer: "PreTrainedTokenizer") -> None:
        ...
        if stop_words:
            ...
            except TypeError:  # transformers>=5.2 removes this kwarg
...
register_template(
    name="qwen3_dsl_nothink",
    format_user=StringFormatter(
        slots=["<|im_start|>user\n{{content}}<|im_end|>\n<|im_start|>assistant\n<think>\n\n</think>\n\n"]
    ),
    format_assistant=StringFormatter(slots=["{{content}}<|im_end|>\n"]),
    format_system=StringFormatter(slots=["<|im_start|>system\n{{content}}<|im_end|>\n"]),
    format_function=FunctionFormatter(slots=["{{content}}<|im_end|>\n"], tool_format="call_dsl"),
    format_observation=StringFormatter(
        slots=[
            "<|im_start|>user\n<tool_response>\n{{content}}\n</tool_response><|im_end|>\n"
            "<|im_start|>assistant\n<think>\n\n</think>\n\n"
    ...
    format_tools=ToolFormatter(tool_format="call_dsl"),
    stop_words=["<|im_end|>"],
)
...
register_template(
    ...
    stop_words=["<|im_end|>"],
    mm_plugin=get_mm_plugin(name="internvl", image_token="<IMG_CONTEXT>"),
)
